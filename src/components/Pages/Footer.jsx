    ...
    <footer className="bg-secondary text-foreground px-auto  bottom-0 z-50">
      <div className="container mx-auto flex flex-col md:flex-row justify-between  py-10 lg:px-20">
        <div className="flex items-center mb-4 md:mb-0">
          <img src="/images/logo-muted-2.png" alt="Starbucks Logo" className="max-h-52 max-w-52" />
        ...
        <div className="flex flex-col md:flex-row">
          <div className="mr-10">
            ...
            <ul>
              <li><a href="#" className="text-muted-foreground hover:text-primary">Our Heritage</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary">Coffeehouse</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary">Our Company</a></li>
            </ul>
          </div>
          <div className="mr-10">
            <h3 className="font-semibold mb-2 text-primary-foreground">Responsibility</h3>
            <ul>
              <li><a href="#" className="text-muted-foreground hover:text-primary">Diversity</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary">Community</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary">Ethical Sourcing</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary">Environmental Stewardship</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary">Learn More</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul>
              ...
              <li><a href="#" className="text-muted-foreground hover:text-primary">Customer Service</a></li>
