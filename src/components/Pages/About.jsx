            ...
            <div className="bg-background mx-auto max-w-7xl pt-10 sm:py-18 p-6 rounded-lg shadow-lg">
                ...
                <div className="flex flex-col lg:flex-row-reverse items-center my-6">
                    ...
                    <div className="lg:w-1/2 lg:pr-8">
                        <p className="text-gray-700 text-lg mb-4">
                            ...
                            The choice of coffee beans and their grind size plays a crucial role in determining the flavor of your brew. Each type of bean offers a unique array of flavors and aromas, making every brewing session an adventure in taste.                        </p>
                    </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row items-center my-6">
                    ...
                    <div className="lg:w-1/2 lg:pl-8">
                        ...
                        <p className="text-gray-700 text-lg mb-4">
                            Our state-of-the-art coffee machines provide unmatched consistency in brewing. By automating the process, they allow for precise control over critical brewing variables like temperature and timing, ensuring a perfect cup every time.                        </p>
                    </div>
                </div>
