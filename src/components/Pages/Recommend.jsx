        ...
        {items.map((item, index) => (
          <div key={index} className="px-2"> {/* Added padding for spacing */}
            <div className="bg-muted-foreground rounded-lg shadow-md flex flex-col p-4 relative min-w-7 md:min-w-8">
              <img
                src={item.imageUrl}
                alt={item.title} // Improved accessibility
                className="w-full h-32 object-cover mb-4 mx-auto" // Ensure consistent image size
              />
              ...
              <div className="flex justify-between items-center mt-4">
                ...
                <button
                  ...
                  onClick={() => handleAddItem(item)} // Adding functionality to the button
                >
                  Add Item
                </button>
              </div>
